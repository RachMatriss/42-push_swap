...
### Bonus 
 => to create checker try ```make bonus```
...
## Check  
=> to do a fast check with random numbers try ```make check```
```
========= Tests running ... ======== 
 
 running with 3 numbers... 	OK
 number of instructions... 	1

 running with 5 numbers... 	OK
 number of instructions... 	6

 running with 100 numbers... 	OK
 number of instructions... 	1084

 running with 500 numbers... 	OK
 number of instructions... 	6784

```

![push swap make check](/img0.png)
...
- [Algorithms video](https://youtu.be/7KW59UO55TQ)
